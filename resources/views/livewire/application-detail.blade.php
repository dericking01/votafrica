<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-stone-50 p-4 sm:p-6 lg:p-8">
    <div class="mx-auto max-w-6xl space-y-6">
        <div class="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white/90 p-4 shadow-sm sm:p-6 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex w-full flex-wrap items-center gap-3 sm:w-auto sm:justify-end">
                @if($isEditing)
                    <button type="button"
                            ...
                            class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto">
                        <span wire:loading.remove wire:target="saveEdit">Save changes</span>
                        <span wire:loading wire:target="saveEdit">Saving...</span>
                    </button>
                    <button type="button"
                            wire:click="cancelEdit"
                            class="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-100 sm:w-auto">
                        Cancel
                    </button>
                @else
                    <button type="button"
                ...
                @else
                    <button type="button"
                            ...
                            wire:loading.attr="disabled"
                            wire:target="archive"
                            class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-rose-100 px-4 py-2.5 text-sm font-semibold text-rose-700 transition-colors hover:bg-rose-200 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
        ...
        <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
            <div class="flex items-start gap-4 border-b border-slate-100 px-4 py-4 sm:items-center sm:px-6 sm:py-5">
